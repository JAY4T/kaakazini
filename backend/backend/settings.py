...
if USE_SPACES:
    ...
    SPACES_REGION = config("SPACES_REGION", default="fra1")
    SPACES_ENDPOINT_URL = config(
        "SPACES_ENDPOINT_URL",
        default=f"https://{SPACES_REGION}.digitaloceanspaces.com"
    )

    MEDIA_URL = f"{SPACES_ENDPOINT_URL}/{SPACES_BUCKET_NAME}/"
    ...
    AWS_S3_CUSTOM_DOMAIN = f"{SPACES_BUCKET_NAME}.{SPACES_REGION}.digitaloceanspaces.com"
else:
    MEDIA_URL = "/media/"
